...
public:
    ...
    * @param x0, y0 (x,y) coordinates of circle to draw
   ...
   /*
    * @param x0, y0 (x,y) coordinates of rectangle to draw
    * @param width, height size of rectangle
    * @param color pixel color
    */
   void drawRectangleOutline(int x0, int y0, int width, int height, int color);
